...
function normalizeFlexpayToken(value) {
...
export const env = {
    ...
    flexpay: {
        ...
        mobileApiUrl: process.env.FLEXPAY_MOBILE_API_URL ??
            'https://backend.flexpay.cd/api/rest/v1/paymentService',
        cardApiUrl: process.env.FLEXPAY_CARD_API_URL ?? 'https://cardpayment.flexpay.cd/v1/pay',
        checkApiUrl: process.env.FLEXPAY_CHECK_API_URL ?? 'https://backend.flexpay.cd/api/rest/v1/check',
    },
    sms: {
